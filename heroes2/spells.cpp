...
spelli bsmeta<spelli>::elements[] = {{"Огненный шар", 9, 3, 8, 1, {Hostile, Area, Fire}, CombatSpell, "Заставляет огромный шар огня попасть в указанную область, поражая всех существ вокруг."},
{"Огненный взрыв", 15, 4, 9, 15, {Hostile, LargeArea, Fire}, CombatSpell, "Улучшенная версия Огненного шара поражает две клетки вокруг точки попадания вместо одной. Наносит %1i урона за каждый уровень Силы Магии."},
{"Молния", 7, 2, 4, 25, {Hostile, Lighting}, CombatSpell, "Разряд электрической энергии поражает указанное существо нанося %1i урона на уровень Силы Магии."},
{"Цепь молний", 15, 4, 5, 40, {Hostile, Lighting}, CombatSpell, "Электрический разряд поражает выбранное существо, затем поражает соседнее существо с половиной урона, затем следующее соседнее существо с половиной урона и т.д. Внимание - это заклинание может поразить дружественных существ."},
...
{"Святое слово", 9, 3, 22, 10, {Hostile, Mass}, CombatSpell, "Наносит повреждения всем мертвецам в битве. Урон равен %1i на каждый уровень Силы Магии."},
{"Святой крик", 12, 4, 23, 20, {Hostile, Mass}, CombatSpell, "Наносит повреждения всем мертвецам в битве. Урон равен %1i на каждый уровень Силы Магии. Это улучшенная версия Святого слова."},
...
{"Волшебная стрела", 3, 1, 38, 10, {Hostile}, CombatSpell, "Волшебная стрела наносит урон выбранному существу. Урон равен %1i на каждый уровень Силы магии."},
{"Берсеркер", 12, 3, 19, 0, {Hostile}, CombatSpell, "Заставляет существо атаковать его соседа."},
{"Армагедон", 20, 5, 16, 50, {Hostile, Mass, Fire}, CombatSpell, "Ужасный взрыв поражает все поле битвы нанося страшные повреждения все присуствующим. Урон равен %1i на каждый уровень Силы Магии."},
{"Буря элементов", 15, 4, 11, 25, {Hostile, Mass}, CombatSpell, "Элементы стихии обрушиваются на поле битвы, нанося %1i урона на каждый уровень Силы Магии каждому существу."},
{"Метеоритный дождь", 15, 4, 24, 25, {Hostile, Area}, CombatSpell, "Метеоритный дождь обрушивается с неба и наносит всем соседним существам %1i урона на каждый уровень Силы Магии."},
{"Паралич", 9, 3, 20, 0, {Enchantment, Hostile}, CombatSpell, "Выбранное существо парализовано и лишино возможности двигаться и отвечать на атаку."},
...
{"Луч холода", 6, 2, 36, 20, {Hostile, Cold}, CombatSpell, "Высасывает жизненное тепло с вражеского отряда. Наносит %1i урона на каждый уровень Силы Магии."},
{"Кольцо холода", 9, 3, 35, 10, {Hostile, Cold}, CombatSpell, "Высасывает жизненное тепло из всех отрядов вокруг центра, но не включая центр. Наносит %1i урона на каждый уровень Силы Магии."},
{"Луч разрушения", 7, 2, 34, 3, {Enchantment, Hostile}, CombatSpell, "Снижает защиту вражеского отряда на %1i."},
{"Дрожь смерти", 6, 2, 28, 5, {Hostile}, CombatSpell, "Наносит %1i на каждый уровень Силы Магии урона всем живым (не мертвецам) на поле боя."},
{"Волна смерти", 10, 3, 29, 10, {Hostile}, CombatSpell, "Наносит %1i на каждый уровень Силы Магии урона всем живым (не мертвецам) на поле боя. Эта улучшенная версия заклинания Дрожь смерти."},
