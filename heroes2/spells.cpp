...
{"Метеоритный дождь", 15, 4, 24, 25, {Hostile, Area, Damage}, CombatSpell, "Метеоритный дождь обрушивается с неба и наносит всем соседним существам %1i урона на каждый уровень Силы Магии."},
...
{"Вызов элементаля земли", 30, 5, 56, 3, {Friendly, Summon}, CombatSpell, "Summons Earth Elementals to fight for your army."},
...
{"Стражи земли", 15, 4, 52, 4, {}, AdventureSpell, "Sets Earth Elementals to guard a mine against enemy armies."},
{"Стражи воздуха", 15, 4, 53, 4, {Lighting}, AdventureSpell, "Sets Air Elementals to guard a mine against enemy armies."},
